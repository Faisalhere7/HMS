...
<img className='w-20 h-20 rounded-lg' src="https://avatars.mds.yandex.net/i?id=ea6e17f0d187067bdf69eafe8bf7ff219f4bd6b7-5086977-images-thumbs&n=13" alt="" />
          ...
          <div className="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0 ">
            ...
            <a href="instagram.com" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-gray-900 to-gray-900  
                  ">
            ...
            <a href="web.facebook.com" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#337FFF]  hover:bg-gray-900 ">
            ...
            <a href="https://www.youtube.com/" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#FF0000]  hover:bg-gray-900 ">
        ...
        <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
          ...
          <ul className="text-gray-600  transition-all duration-500">
            <li className="mb-6">Bhakkar@hospital.com</li>
            <li className="mb-6">+92 345434553</li>
            <li>E-Hospital Bhakkar, Punjab, Pakistan.</li>
          </ul>
        </div>
        {/*End Col*/}
        <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:order-last sm:col-span-4 md:col-span-4 lg:order-none lg:col-span-1">
          ...
          <ul className="text-gray-600 transition-all duration-500  ">
            ...
            <li className="mb-6"><a href="/contact" className=" text-gray-600 hover:text-gray-900">Contact</a></li>
            <li className="mb-6"><a href="/registered/doctor" className=" text-gray-600 hover:text-gray-900">Our Team</a></li>
            <li className="sm:mb-6"><a href="/createappointment" className=" text-gray-600 hover:text-gray-900">Appointment</a></li>
          </ul>
        </div>
