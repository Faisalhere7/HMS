...
const Herosection = () => {
  return (
    <div className="w-full py-10 bg-gray-100 container">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
             <Link to={"/contact"}> <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full font-semibold transition-colors duration-200 shadow-lg hover:shadow-xl">
                Contact Us
              </button></Link>
            <Link to={"/registered/doctor"}>  <button className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-3 rounded-full font-semibold transition-all duration-200">
          Meet With Our Team
              </button></Link>
            </div>
          </div>
