          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-12">
              <div className="flex items-center space-x-3 bg-white rounded-full px-6 py-3 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <span className="font-semibold text-gray-700">0345678905</span>
              </div>
              <div className="flex items-center space-x-3 bg-white rounded-full px-6 py-3 shadow-lg hover:shadow-xl transition-shadow">
                <Mail className="w-5 h-5 text-cyan-600" />
                <span className="font-semibold text-gray-700">Bhakkar@info.com</span>
              </div>
              <div className="flex items-center space-x-3 bg-white rounded-full px-6 py-3 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">E-Hospital<br />Medical District, Bhakkar</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">0323456789</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Bhakkar@info.com</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      >
        ...
        <div className="bg-gradient-to-r from-gray-900 to-blue-900 text-white py-12">
          <div className="max-w-4xl mx-auto text-center px-4">
           ...
           <a href="https://wa.me/923486921612" target="_blank" rel="noopener noreferrer">
